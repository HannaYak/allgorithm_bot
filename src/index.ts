...
const STOCK_QUESTIONS = [
  { 
    ...
    hints: ["1. Ровно столько городов и крепостей удостоены звания «Город-герой» или «Крепость-герой».", "2. Ровно столько лунных циклов проходит за один земной год.", "3. Это несчастливое число из названия франшизы хорроров про Джейсона Вурхиза."], 
    answer: "13", 
    fact: "Интересный факт: эти 13 народов образуют самую большую языковую группу в Европе." 
  },
  { 
    question: "Согласно вавилонскому представлению о мире, он состоит именно из такого количества частей. Назовите число:", 
    hints: ["1. Через столько столиц проходила пресловутая «Ось зла».", "2. Ровно столько кружек пива жестом заказал герой в фильме «Бесславные ублюдки».", "3. Столько империй участвовало в трёх разделах Речи Посполитой."], 
    answer: "3", 
    fact: "Для вавилонян число 3 было сакральным и определяло структуру мироздания." 
  },
  { 
    question: "Назовите модельный номер знаменитого самолёта «Сверхкрепость», участвовавшего в обоих ядерных бомбардировках Японии.", 
    hints: ["1. Максимальное расстояние между Землей и Плутоном в астрономических единицах.", "2. Последние две цифры года начала Великой депрессии в США.", "3. Столько дней в феврале в високосный год."], 
    answer: "29", 
    fact: "Разработка B-29 обошлась в 3 млрд долларов — это дороже, чем создание самой атомной бомбы!" 
  },
  { 
    question: "Китай — старейшая непрерывная цивилизация. Назовите, сколько всего династий правило в нём?", 
    hints: ["1. Число, от которого отталкивалась математика древних Майя.", "2. Ровно столько молочных зубов должно быть у здорового человека.", "3. Столько тысяч лье под водой в названии произведения Жюля Верна."], 
    answer: "20", 
    fact: "Китай сменил 20 династий за 4000 лет истории, от династии Ся до падения Цин в 1912 году." 
  },
  { 
    question: "В 2007 году человечество обновило список чудес света. Назовите количество новых чудес света.", 
    hints: ["1. Именно столько звёзд образуют созвездие Большой медведицы.", "2. Номер январского дня, в который празднуется православное Рождество.", "3. Именно столько футов под килем упоминается в знаменитом пожелании морякам."], 
    answer: "7", 
    fact: "В список вошли:  Великая Китайская стена, Петра, Колизей, Чичен-Ица, Мачу-Пикчу, Тадж-Махал и Статуя Христа-Искупителя. Египет отказался участвовать в конкурсе." 
  },
  { 
    question: "Назовите число лунных циклов, которые проходят между летними Олимпийскими играми.", 
    hints: ["1. Юбилей брака, именуемый «Золотой свадьбой».", "2. Количество штатов, входящих в состав США на данный момент.", "3. Число из псевдонима рэпера, который выжил после 9 пуль."], 
    answer: "50", 
    fact: "Число 50 объединяет золотой юбилей, штаты Америки и легендарного 50 Cent." 
  },
  { 
    question: "Назовите, сколько родов войск обычно насчитывается в большинстве стран?", 
    hints: ["1. Именно столько базовых чувств человека выделил Аристотель.", "2. Ровно столько стран являются постоянными членами Совета Безопасности ООН.", "3. Порядковый номер «Элемента» в названии фильма с Милой Йовович."], 
    answer: "5", 
  ...
  { 
    ...
    hints: ["1. Столько камней поставил Моисей у подножья Синайской горы.", "2. Ровно столько великих подвигов совершил античный герой Геракл, чтобы искупить свою вину перед богами.", "3. Количество разгневанных мужчин в названии классического судебного фильма."], 
    answer: "12", 
    fact: "Всего 12 астронавтов ходили по Луне. Алан Шепард даже умудрился сыграть там в гольф." 
  },
  { 
    question: "Сколько недель простоял маленький город Козельск против орды Батыя в 1238 году?", 
    hints: ["1. Столько планет насчитывается в Солнечной системе (без Плутона).", "2. Число, равное количеству континентов на планете Земля.", "3. Именно столько основных нот в музыкальной гамме."], 
    answer: "7", 
    fact: "Деревянный город держался 49 дней против величайшей армии того времени." 
  },
  { 
    question: "Принято считать, что именно столько существует основных сортов чая.", 
    hints: ["1. Количество игроков одной команды на волейбольной площадке.", "2. Среднее количество ног у насекомых с самым распространенным строением тела.", "3. Количество букв в английском алфавите от E до K включительно."], 
    answer: "6", 
    fact: "Это белый, зеленый, желтый, улун, черный и пуэр. Все они растут на одном растении!" 
  },
  { 
    question: "Гарнизон Брестской крепости держал оборону невероятное количество дней. Назовите число.", 
    hints: ["1. Атомный номер химического элемента Германий.", "2. Точка замерзания воды по шкале Фаренгейта.", "3. Именно столько зубов во рту взрослого здорового человека."], 
    answer: "32", 
    fact: "Крепость держалась 32 дня, когда вся остальная линия фронта была уже прорвана." 
  },
  { 
    question: "1937 год. Эпоха дирижаблей. Какова была длина легендарного немецкого дирижабля «Гинденбург» в метрах?", 
    hints: ["1. Телефонный код государства Гвинея-Бисау.", "2. Длительность режиссерской версии фильма «Возвращение короля».", "3. В национальном Покедексе под этим номером значится легендарный покемон Суикун (Suicune). Он олицетворяет северный ветер и чистоту родниковой воды."], 
    answer: "245", 
    fact: "Это самый большой дирижабль в истории. Последний его пассажир умер в 2019 году." 
  },
  { 
    question: "Кристиан Диор присвоил это «счастливое» число своей самой продаваемой помаде. Назовите его.", 
    hints: ["1. Три последние цифры года, когда ждали «крах компьютеров» из-за проблемы Y2K.", "2. Короткий номер вызова скорой помощи в Польше.", "3. Трехзначный палиндром, который больше 900, но меньше 1000."], 
    answer: "999", 
    fact: "Культовый оттенок 999 символизирует пламя и до сих пор является хитом Dior." 
  },
  { 
    question: "В скольких тюрьмах побывал за свою жизнь буйный рецидивист Чарльз Бронсон?", 
    hints: ["1. Количество лет, которыми Бог ограничил жизнь смертных перед Потопом.", "2. Столько тонн крови в год перекачивает человеческое сердце по данным сценария.", "3. Римская запись этого числа выглядит как CXX."], 
    answer: "120", 
    fact: "Бронсон сменил 120 тюрем. Он прославился тем, что гнул руками тюремные решетки." 
  },
  { 
    question: "Сколько спутников у Юпитера официально подтверждено на текущий момент?", 
    hints: ["1. Октановый номер бензина премиум-класса в Европе.", "2. Последние две цифры года выхода мультфильма «История игрушек».", "3. Именно столько тезисов Мартин Лютер прибил к дверям церкви."], 
    answer: "95", 
    fact: "Юпитер — король спутников. Астрономы полагают, что их может быть более 600." 
  },
  { 
    question: "На сколько процентов по массе земной коры наша планета состоит из кислорода?", 
    hints: ["1. Атомный номер химического элемента Индий.", "2. Год до н.э., в котором началась Гражданская война Цезаря с Помпеем.", "3. Число, которое в Японии означает «смертные муки»."], 
    answer: "49", 
    fact: "Почти половина Земли — это кислород, связанный в песке, глине и скалах." 
  },
  { 
    question: "Какое число стоит в названии клуба музыкантов, умерших на пике славы (Кобейн, Хендрикс)?", 
    hints: ["1. Столько костей в кисти руки взрослого человека.", "2. Столько поправок внесено в Конституцию США за всю историю.", "3. Столько стран входит в состав Евросоюза."], 
    answer: "27", 
    fact: "«Клуб 27» — печально известная группа гениальных музыкантов, ушедших в этом возрасте." 
  },
  { 
    question: "Сколько лет провел в заточении в частной тюрьме герой корейского фильма «Олдбой»?", 
    hints: ["1. Номер аркана «Дьявол» в картах Таро.", "2. Столько лет было «капитану» Жюля Верна.", "3. Количество костяшек с числами в классической игре-головоломке."], 
    answer: "15", 
    fact: "Герой провел в изоляции 15 лет, не зная причин своего пленения." 
  },
  { 
    question: "Сколько всего Великих Домов Вестероса выделяют в каноне «Игры Престолов»?", 
    hints: ["1. Номер симфонии Бетховена, где звучит «Ода к радости».", "2. Наибольшее однозначное число в десятичной системе.", "3. Столько месяцев длится стандартная беременность."], 
    answer: "9", 
    fact: "Хотя королевств семь, Великих Домов (Старки, Ланнистеры и др.) в каноне девять." 
  },
  { 
    question: "Сколько гномов-спутников Бильбо Бэггинса входило в отряд Торина Дубощита?", 
    hints: ["1. Именно столько полос (красных и белых) на флаге США.", "2. Столько карт одной масти в стандартной колоде от двойки до туза.", "3. Это число часто называют «Чёртовой дюжиной»."], 
    answer: "13", 
    fact: "В отряде было 13 гномов, поэтому им понадобился 14-й участник — Бильбо." 
  },
  { 
    question: "Назовите номер правила интернета, гласящего: «Если это существует, про это есть порнография».", 
    hints: ["1. Телефонный код Испании.", "2. Номер легендарного советского танка Т-...", "3. Игровой номер Шакила О’Нила в команде «Лейкерс»."], 
    answer: "34", 
    fact: "Правило 34 — одно из самых известных негласных правил цифрового мира." 
  },
  { 
    question: "Какой номер был у главного героя (последнего участника) в сериале «Игра в кальмара»?", 
    hints: ["1. Прямая числовая последовательность из трех цифр.", "2. Результат вычитания кода ошибки «Not Found» из числа 860.", "3. Число из названия спорткара Ferrari GT."], 
    answer: "456", 
    fact: "Сон Ги Хун носил номер 456 — последний порядковый номер участника игры." 
  },
  { 
    question: "Сколько официальных студийных альбомов выпустила группа The Beatles?", 
    hints: ["1. Атомный номер элемента Алюминий.", "2. Ровно столько карт одной масти в стандартной колоде.", "3. Число, которое авиакомпании часто пропускают при нумерации рядов."], 
    answer: "13", 
    fact: "13 альбомов «Ливерпульской четверки» навсегда изменили историю музыки." 
  },
  { 
    question: "Совет Братства из «Пиратов Карибского моря». Сколько пиратских баронов в него входило?", 
    hints: ["1. Ровно столько кругов ада описал Данте.", "2. Столько Назгулов искали Фродо во «Властелине Колец».", "3. У кошки, согласно поверьям, именно столько жизней."], 
    answer: "9", 
    fact: "Девять баронов должны были собрать девять песо, чтобы освободить Калипсо." 
  },
  { 
    question: "Сингл Scorpions «Wind of Change» стал гимном целой эпохи. В каком году он вышел?", 
    hints: ["1. Год выхода альбома «Nevermind» группы Nirvana.", "2. Год является палиндромом.", "3. Год заключения Беловежского соглашения."], 
    answer: "1991", 
    fact: "Этот год стал точкой невозврата и ознаменовал окончание Холодной войны." 
  },
  { 
