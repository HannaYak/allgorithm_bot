  ...
  },
{
    ...
    hints: [
      ...
      "2. Столько лет (ровно 8 веков) правила самая долгая династия в Китае — Чжоу.",
      "3. Это число произносится как восемь сотен."
    ],
    answer: "800",
    fact: "з-за огромной популярности этого кода в США закончились комбинации номеров, и властям пришлось вводить дополнительные коды (888, 877, 866), но этот — самый первый и престижный."
  },
{
...
{
    question: "Советский Союз (СССР) был огромной империей. Сколько лет просуществовало это государство?",
    hints: [
      "1. Это число является символом знака зодиака Рак (если повернуть его боком).",
      "2. Самая известная поза во французской любви.",
      "3. Государству не хватило всего 1 года до 70-летнего юбилея."
    ],
    answer: "69",
    fact: "За время существования территория страны увеличилась почти на 2 млн кв. км."
  },
{
  ...
  },
{
    ...
    answer: "9",
    fact: "Знаменитая фраза про то, что Пиратский Кодекс — это «не свод законов, а просто свод указаний», на самом деле имеет исторические корни. У реальных пиратов были свои «статьи» (articles), которые подписывал каждый член экипажа, но они часто менялись в зависимости от капитана и обстоятельств."
  },
{
  ...
  },
{
    ...
    hints: [
      "1. Именно столько лет длится стандартный цикл солнечной активности. Каждые 11 лет магнитные полюса Солнца меняются местами, вызывая всплески северных сияний и магнитных бурь на Земле.",
      "2. Прозвище главной героини сериала «Очень странные дела» (Оди).",
  ...
  },
{
    ...
    answer: "999",
    fact: "На самом деле, это число — дань уважения первым двум помадам, которые выпустил Кристиан Диор в 1953 году. Они назывались просто №9 и №99. Позже их объединили в одну «идеальную» формулу, и она получила номер 999. В нумерологии девятка символизирует успех, завершенность и божественную энергию. Диор верил, что три девятки усиливают это везение в кубе."
  },
{
  ...
  },
{
    ...
    hints: [
      ...
      "2. Именно столько разгневанных мужчин участвуют в названии классического американского фильма про тяжбы судебного процесса",
      "3. Число рёбер куба и октаэдра"
    ],
    answer: "12",
    fact: "Все 12 человек были американцами и летали на Луну в рамках программы «Аполлон» в период с 1969 по 1972 год. После 1972 года — тишина. Вот уже более 50 лет ни одна человеческая нога не касалась лунной пыли."
  },
{
    ...
    answer: "16",
    fact: "Это число является «идеальным квадратом» и четвертой степенью двойки"
  },
{
