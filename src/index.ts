...
const STOCK_QUESTIONS = [
  ...
  { 
    ...
    hints: ["1. Число, от которого отталкивалась двадцатеричная математика древних Майя.", "2. Ровно столько молочных зубов должно быть у здорового человека.", "3. Столько тысяч лье под водой в названии произведения Жюля Верна."], 
    answer: "20", 
  ...
  { 
    ...
    answer: "7", 
    fact: "В список вошли: Великая Китайская стена, Петра, Мачу-Пикчу, Колизей и др. Египет отказался участвовать в конкурсе." 
  },
  { 
  ...
  { 
    ...
    hints: ["1. Столько камней поставил Моисей у подножья Синайской горы.", "2. Столько букв насчитывается в гавайском алфавите (самый короткий в мире).", "3. Количество разгневанных мужчин в названии классического судебного фильма."], 
    answer: "12", 
  ...
  { 
    question: "Какова была длина (в метрах) легендарного дирижабля «Гинденбург»?", 
    hints: ["1. Телефонный код государства Гвинея-Бисау.", "2. Длительность режиссерской версии фильма «Возвращение короля».", "3. Столько лет назад (от 2028 г.) закончилось Восстание в США против британской короны."], 
    answer: "245", 
  ...
  { 
    ...
    hints: ["1. Номер аркана «Дьявол» в картах Таро.", "2. Столько лет было «Пятнадцатилетнему капитану» Жюля Верна.", "3. Количество костяшек с числами в классической игре-головоломке."], 
    answer: "15", 
