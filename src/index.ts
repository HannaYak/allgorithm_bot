...
const STOCK_QUESTIONS = [
  ...
  { question: "Назовите модельный номер знаменитого самолёта «Сверхкрепость», участвовавшего в ядерных бомбардировках.", hints: ["1. Расстояние Земля-Нептун (а.е.).", "2. Последние две цифры года начала Великой депрессии.", "3. Столько дней в феврале в високосный год."], answer: "29", fact: "B-29 стоил 3 млрд долларов!" },
  ...
  { question: "Сколько недель простоял Козельск против орды Батыя в 1238 году?", hints: ["1. Столько чудес света в классическом списке.", "2. Количество континентов (в одной из моделей).", "3. Именно столько основных нот."], answer: "7", fact: "Козельск прозвали «злым городом»." },
  { question: "Принято считать, что именно столько существует основных сортов чая.", hints: ["1. Столько игроков на поле в волейболе.", "2. Среднее количество ног у насекомых.", "3. Столько сторон у игральной кости (кубика)."], answer: "6", fact: "Зелёный, чёрный, белый, улун, пуэр и жёлтый." },
  { question: "Гарнизон Брестской крепости держал оборону невероятное количество дней. Назовите число.", hints: ["1. Атомный номер Германия.", "2. Точка замерзания воды по Фаренгейту.", "3. Именно столько зубов во рту взрослого человека."], answer: "32", fact: "Крепость держалась 32 дня." },
  { question: "Какова была длина (в метрах) легендарного дирижабля «Гинденбург»?", hints: ["1. Телефонный код Гвинеи-Бисау.", "2. Длительность режиссерской версии «Возвращения короля» (мин).", "3. Столько лет назад (от 2028) закончилось Восстание в США."], answer: "245", fact: "Это как три самолета Боинг 747!" },
  { question: "Какое счастливое число присвоил Кристиан Диор своей самой продаваемой помаде?", hints: ["1. Три девятки — перевернутое число дьявола.", "2. Последние три цифры года выхода первой «Матрицы».", "3. Трехзначный палиндром между 900 и 1000."], answer: "999", fact: "Оттенок 999 — самый узнаваемый красный цвет." },
  { question: "В скольких тюрьмах побывал Чарльз Бронсон?", hints: ["1. Количество лет жизни людей до Потопа (по Библии).", "2. Именно столько минут в двух часах.", "3. Число CXX в римской системе."], answer: "120", fact: "Бронсон сменил 120 тюрем." },
  { question: "Сколько спутников у Юпитера официально подтверждено на текущий момент?", hints: ["1. Октановое число бензина «Премиум».", "2. Последние две цифры года выхода «Истории игрушек».", "3. Количество тезисов Мартина Лютера."], answer: "95", fact: "Юпитер — настоящий король спутников." },
  { question: "На сколько процентов по массе земной коры наша планета состоит из кислорода?", hints: ["1. Атомный номер элемента индий.", "2. Год до н.э., когда Цезарь перешел Рубикон.", "3. Число «смертных мук» в японском буддизме."], answer: "49", fact: "Почти половина веса земли — это кислород!" },
  ...
  { question: "Сколько Великих Домов Вестероса выделяют в каноне «Игры Престолов»?", hints: ["1. Номер последней завершенной симфонии Бетховена.", "2. Наибольшее однозначное число.", "3. Столько месяцев длится беременность."], answer: "9", fact: "Семь королевств, но Девять великих домов." },
  ...
  { question: "Назовите номер правила интернета про контент для взрослых.", hints: ["1. Телефонный код Испании.", "2. Номер легендарного танка Т-...", "3. Номер Шакила О’Нила."], answer: "34", fact: "Правило 34 — закон интернета." },
  { question: "Какой номер был у главного героя в «Игре в кальмара»?", hints: ["1. Простая последовательность 4, 5, 6.", "2. Разница между 860 и ошибкой 404.", "3. Название модели Ferrari."], answer: "456", fact: "Сон Ги Хун — игрок номер 456." },
  ...
  { question: "В каком году вышел хит «Wind of Change» группы Scorpions?", hints: ["1. Год выхода альбома «Nevermind» Nirvana.", "2. Год-палиндром.", "3. Год распада СССР."], answer: "1991", fact: "Гимн окончания холодной войны." },
