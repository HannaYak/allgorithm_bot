...
const registerScene = new Scenes.WizardScene('REGISTER_SCENE',
  async (ctx) => { ctx.reply('👋 "Привет! Добро пожаловать в наш клуб знакомств, общения и интересных встреч.\n\n"
  ...
  async (ctx) => {
    ...
    ctx.reply('✅ Регистрация завершена! Добро пожаловать к нам.', getMainKeyboard());
