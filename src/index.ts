...
const CONVERSATION_TOPICS = [
  "Если бы ты мог/ла пригласить кого-нибудь на ужин(из мёртвых или живых), кого бы ты выбрал/а и почему?", "Хотел/а бы ты быть знаменитым/ой? Если да, то чем?", "Прежде чем сделать звонок, ты репетируешь свою реплику?", "Когда ты в последний раз пел/а в одиночестве?", "Если бы ты мог/ла прожить до 100 лет, сохранив разум или тело 30-летнего, что бы выбрал/а?", "За что ты испытываешь наибольшую благодарность?", "Если бы ты мог, что бы ты изменил/а в воспитании себя?", "Если бы ты мог/ла проснуться с новым умением, что бы это было?", "Если бы магический кристалл мог открыть правду, о чем бы ты узнал?", "Есть ли что-то, что ты давно мечтаешь сделать?", "Самое большое достижение в твоей жизни?", "Что в дружбе для тебя наиболее ценно?", "Какое твое самое дорогое воспоминание?",  "Что для тебя значит дружба?", "Какую роль любовь играет в твоей жизни?",  "Продолжите фразу: «Я бы хотел, чтобы был кто-то, с кем можно разделить…»", "Поделитесь смущающим моментом из жизни.",  "Что ты ценишь в людях и почему?",   "Дом горит. Что спасешь (кроме живых существ, документов и денег)?", "Что в этом году случилось впервые?", "Какие качества ты любишь и ненавидишь в себе?", "Что для Вас значит слово успех(не считая деньги)?", "Что бы вы сказали себе 15-летнему?", "О чём вы можете говорить часами?", "Какой лучший совет Вам давали?", "Без чего не проживаете ни дня?", "Если бы пришлось есть одно блюдо всю жизнь, что это было бы?", "Твой «Бесполезный талант»?", "Что популярно, но тебя бесит?", "Место, которое разочаровало? И куда хочешь вернуться?", "Роли в зомби-апокалипсисе: лидер, предатель, первая жертва. Кто ты?", "100 млн долларов, но нельзя тратить на себя. Куда денешь?", "Путешествие во времени, у тебя только 1 час (можно только смотреть). Куда отправишься?", "Кем мечтал стать в 7 лет?", "За что тебя выгоняли из класса?", "Месяц без смартфона за миллион?", "Кот или собака? Продай мне выбор.", "Твое самое непопулярное мнение?(Например: "Я ненавижу сериал 'Друзья'")", "Какую самую глупую вещь ты купил, поддавшись рекламе?", "Какую песню ты включаешь, когда никто не слышит, и тебе за нее стыдно?", "Если бы ты мог отменить один любой закон (физики или юридический), что бы это было?", "Какое качество в людях ты считаешь самым переоцененным? Почему?", "Какой праздник нужно отменить навсегда?", "Какой сериал все обожают, а ты терпеть не можешь?", "Твоя самая бесполезная покупка за последний год?", "Какое реалити-шоу — твой «тайный грех»?", "Твой самый дурацкий способ потратить время в интернете?", "Какую детскую привычку ты сохранил/а до сих пор?", "Какую суперсилу ты бы выбрал/а для бытовых нужд (например, мгновенная сушка волос)?", "Если бы ты мог/ла переехать в любую страну завтра, куда бы точно НЕ поехал/а? Почему?", "Что ты выберешь: всегда говорить правду или всегда только врать?", "Если бы тебе платили за хобби, чем бы ты занимался/лась?", "Какую профессию ты бы освоил/а, если бы у тебя была вторая жизнь?", "Твой «анти-талант»? То, что у тебя получается хуже всего.", "Кем бы ты был/а в банде грабителей банков (водитель, мозг, хакер или тот, кто всех отвлекает)?", "Если бы ты мог/ла удалить одно мобильное приложение из мира навсегда, что это было бы?", "В какой исторической эпохе ты бы точно не выжил/а?", "Какой один закон ты бы ввел/а для всех жителей Земли на один день?", "Какое блюдо ты считаешь самым переоцененным в мире?", "Если бы можно было оставить только одно приложение на телефоне, что бы это было?", "Искусственный интеллект нас спасет или погубит?", "Какую вещь ты хранишь годами, хотя она тебе не нужна?", "Что ты выберешь: жить в центре в коробке или в огромном доме за городом?", "Олл-инклюзив в Турции или поход с рюкзаком по Исландии?", "Самый ужасный сосед в самолете — это кто?", "Если бы ты мог/ла жить в любой эпохе, кроме нынешней, что бы ты выбрал/а?", "Твой самый большой культурный шок в другой стране?", "Ты бы согласился/лась на полет в один конец на Марс? Почему?", "Какое качество в незнакомых людях тебя подкупает мгновенно?", "Какого актера/актрису ты бы выбрал/а на роль себя в фильме про себя?", "Если бы ты мог/ла украсть один талант у любого человека, что бы это было?", "Если бы ты мог/ла изменить один финал в любом известном фильме/книге, какой именно?", "Какое решение в твоей жизни было самым сложным, но принесло больше всего свободы?",
...
"Если бы ты мог/ла навсегда стереть из памяти один фильм, чтобы посмотреть его заново как в первый раз, что бы это было?", "Если бы твоя жизнь была фильмом, какой жанр это был бы и кто бы написал к нему саундтрек?","Если бы ты мог/ла изменить одно событие в истории человечества, зная, что это изменит и твою нынешнюю жизнь?","Если бы ты мог/ла изменить одно событие в истории человечества, зная, что это изменит и твою нынешнюю жизнь?","Если бы ты мог/ла выбрать себе суперспособность, которая работала бы только ночью, что бы это было?","Какой 'баг' в системе человеческого общения тебя бесит больше всего?","Если бы ты был/а брендом, какой был бы твой главный лозунг?","Какое самое смелое решение ты принял/а, когда все вокруг говорили тебе 'не делай этого'?","В какой мировой заговор тебе чертовски хочется верить, даже если это звучит безумно?","Если бы ты узнал/а, что твоя жизнь — это симуляция, какой первый вопрос ты бы задал/а 'программисту'?","Какую историческую личность ты бы вызвал/а на допрос, чтобы узнать правду об одном конкретном событии?","Какая фраза или слово мгновенно делает человека в твоих глазах 'своим'?","Если бы ты мог/ла 'удалить' один тип поведения у всех людей в мире, что бы это было?","Если бы ты мог/ла 'удалить' один тип поведения у всех людей в мире, что бы это было?","Какая вещь из твоего дома больше всего похожа на артефакт из будущего?","Что в современной культуре кажется тебе самым переоцененным 'трендом'?","Если бы ты мог/ла отправить одно SMS всему миру одновременно, что бы в нем было написано?","Веришь ли ты, что технологии делают нас ближе, или они просто создают иллюзию связи?","Какую детскую мечту ты исполнил/а совсем недавно, будучи взрослым?","Самый странный совет, который ты когда-либо получал/а и который неожиданно сработал?","Какое слово ты используешь чаще всего, когда нервничаешь?","Если бы у тебя был безлимитный бюджет на одну безумную покупку, что бы это было?","За какой один момент в своей жизни тебе хочется поднять бокал прямо сейчас?"];
