...
const STOCK_QUESTIONS = [
  {
    ...
    hints: [
      "1. В этом году в Лондоне вспыхнула Великая эпидемия чумы, ставшая последней масштабной вспышкой этой болезни в Англии.",
      "2. Первые две цифры этого числа — номер века, в котором жил Иван Грозный, а последние две цифры — пенсионный возраст для мужчин в Беларуси.",
      "3. Если вы разделите это число на 5, то получите красивое «число ангела»."
    ],
    answer: "1665",
    fact: "Большинство туристов поднимаются пешком только до второго уровня (674 ступени), а остальной путь до вершины преодолевают только на лифте."
  },
  {
    question: "Согласно данным статистических управлений, именно это невероятное количество островов принадлежит Швеции, что делает её мировым лидером по этому показателю.",
    hints: [
      "1. Это число больше, чем население города Гдыня, но меньше, чем население Белостока .",
      "2. Если вы решите посещать по одному новому шведскому острову каждый день, вам понадобится примерно 733 года, чтобы увидеть их все.",
      "3.  Если убрать у этого числа последний ноль, то первые две цифры совпадут с количеством букв в английском алфавите, а оставшиеся три — с номером легендарной модели самолета Boeing."
    ],
    answer: "267570",
    fact: "Швеция обгоняет даже такие островные государства, как Индонезия и Филиппины. Однако большинство этих островов необитаемы и имеют крошечную площадь."
  },
{
    question: "На сегодняшний день (2026 год) в Шенгенскую зону входит именно такое количество европейских государств, договорившихся об отмене внутреннего пограничного контроля.",
    hints: [
      "1. Именно столько земных лет длится один полный оборот вокруг Солнца у планеты Сатурн. В астрологии это время называют «возвращением Сатурна» — периодом взросления и перемен.",
      "2. В периодической таблице Менделеева под этим атомным номером находится медь (Cu) — металл, который люди начали использовать одним из первых в истории.",
      "3. В математике это число можно получить, если сложить квадраты трех последовательных чисел: два, три и четыре."
    ],
    answer: "29",
    fact: "Шенгенская зона остается крупнейшей в мире территорией свободного передвижения. Последними полноценными участниками к ней присоединились Болгария и Румыния."
},
{
    question: "Назовите номер дома по Пенсильвания-авеню в Вашингтоне, который является официальной и самой узнаваемой резиденцией президента США.",
    hints: [
      "1. Академические стандарты: на протяжении десятилетий это число являлось максимально возможным результатом («идеальным баллом») в классическом американском тесте SAT, который необходим для поступления в престижные колледжи и университеты.",
      "2. Мировая история: именно в этот год (последний день XVI века) была официально основана Британская Ост-Индская компания, навсегда изменившая карту торговых путей и судьбу целых континентов.",
      "3. Промышленный дизайн: в середине 2000-х это число стало названием одной из самых популярных бюджетных моделей телефона-«неубивашки» от Nokia, известной своим цветным экраном и невероятной прочностью корпуса."
    ],
    answer: "1600",
    fact: "Хотя почтовый адрес Белого дома — 1600 Pennsylvania Avenue, это здание не всегда было белым. Своё название оно получило после того, как его стены, обгоревшие после пожара 1814 года, покрасили белой краской, чтобы скрыть следы копоти."
},
{
    question: "Многие считают их безобидными (если не считать зуд), но на самом деле это самые опасные существа на Земле по количеству жертв. А сколько зубов находится во рту у обычного среднестатистического комара?",
    hints: [
      "1. Это число — атомный номер серебра (Ag) в таблице Менделеева.",
      "2. Именно такое количество струн натянуто на раму стандартной классической концертной арфы.",
      "3. Это число — индекс самого известного советского автомата, который попал в Книгу рекордов Гиннесса как самое распространенное оружие в мире."
    ],
    answer: "47",
    fact: "Комариные «зубы» — это микроскопические зазубрины на челюстях, которые помогают им пропиливать кожу. По данным ВОЗ, из-за болезней, переносимых комарами, ежегодно погибает более 700 000 человек."
},
{
    question: "Человеческий скелет — это инженерный шедевр. Сколько костей насчитывает тело взрослого человека? (У младенцев их около 270, но со временем некоторые срастаются).",
    hints: [
      "1. Это число получится, если из значения температуры кипения воды по Фаренгейту (212°F) вычесть количество игроков одной команды на поле в водном поло.",
      "2. Любители французских автомобилей знают это число как название классической модели Peugeot, которая выпускалась более 20 лет и стала легендой ралли.",
      "3.  Если возвести число 14 в квадрат и прибавить к результату 10, вы получите наш ответ)."
    ],
    answer: "206",
    fact: "Самая маленькая кость в нашем теле — стремечко в среднем ухе (её длина всего 3 мм), а самая большая и крепкая — бедренная кость, которая может выдержать вес целого автомобиля."
},
{
    question: "Этот год стал точкой невозврата для человечества. Именно тогда британский ученый Тим Бернерс-Ли запустил самый первый в мире веб-сайт. С этого момента началась эпоха интернета в том виде, в котором мы его знаем. Назовите этот год?",
    hints: [
      "1. Это число — «палиндром» (читается одинаково в обе стороны). Оно выглядит одинаково, даже если перевернуть его вверх ногами.",
      "2. В этот год мир потерял легендарного фронтмена группы Queen — Фредди Меркьюри.",
      "3. Это был год официального распада СССР и окончательного завершения эпохи холодной войны."
    ],
    answer: "1991",
    fact: "Первый сайт (info.cern.ch) до сих пор доступен! Он содержал инструкцию по созданию собственных страниц и объяснял, что такое Всемирная паутина."
},
{
    question: "Самое высокое здание в мире — небоскреб Бурдж-Халифа в Дубае. Сколько метров составляет его полная высота (вместе со шпилем)?",
    hints: [
      "1. Это число совпадает с годом нашей эры, когда венецианские купцы совершили самую дерзкую кражу в истории Церкви: они похитили из Александрии мощи святого Марка, чтобы сделать его покровителем Венеции.",
      "2. Это число в двоичной системе счисления записывается как 1100111100.",
      "3. Чтобы получить точный результат, возьмите количество знаков зодиака, умножьте его на 70 и вычтите из полученного значения количество месяцев в году."
    ],
    answer: "828",
    fact: "Шпиль здания настолько высок, что жильцы последних этажей видят закат на несколько минут позже, чем те, кто стоит у подножия. Во время Рамадана им даже приходится дольше ждать времени ифтара (ужина)."
}, 
{
    question: "Сколько минут длился первый в истории полет человека в космос, совершенный Юрием Гагариным на корабле «Восток-1»?",
    hints: [
      "1. В восточных религиях и практиках (индуизм, буддизм) это число считается священным: именно столько бусин традиционно нанизано на чётки-малы для медитации.",
      "2. Это число можно представить как произведение последовательных степеней: первой степени единицы, второй степени двойки и третьей степени тройки (1¹ × 2² × 3³).",
      "3. В классической геометрии это значение внутреннего угла (в градусах) правильного пятиугольника — фигуры, лежащей в основе архитектуры штаб-квартиры Минобороны США."
    ],
    answer: "108",
    fact: "За эти 108 минут Гагарин успел совершить ровно один полный виток вокруг Земли. Весь полет проходил в автоматическом режиме, так как никто не знал, как человеческая психика отреагирует на условия невесомости."
},
{
    question: "Небоскреб Эмпайр-стейт-билдинг в Нью-Йорке долгое время был самым высоким зданием мира. Сколько этажей насчитывает этот легендарный символ ар-деко?",
    hints: [
      "1. Это число — атомный номер Нобелия, химического элемента, названного в честь учредителя самой престижной научной премии в мире.",
      "2. Сумма количества новелл в классическом «Декамероне» Джованни Боккаччо и количества магнитных полюсов у нашей планеты.",
      "3. Это число соответствует округленной до ближайшего целого относительной атомной массе переходного металла Рутения (Ru)."
    ],
    answer: "102",
    fact: "Эмпайр-стейт-билдинг стал первым зданием в мире, имеющим более 100 этажей. Его построили в рекордные сроки — всего за 410 дней — в самый разгар Великой депрессии."
},
{
    question: "В каком году до нашей эры произошла легендарная битва при Фермопилах, где 300 спартанцев под предводительством царя Леонида противостояли многотысячной армии персов?",
    hints: [
      "1. Это число — стандартная высота кадра (в пикселях) для классического видеорежима VGA, который десятилетиями был эталоном для компьютерных мониторов.",
      "2. Чтобы получить это число, нужно умножить количество знаков зодиака на количество граней правильного икосаэдра (d20) и удвоить результат.",
      "3. Это число — общее количество минут в восьми полных часах."
    ],
    answer: "480",
    fact: "Хотя спартанцы и их союзники погибли, эта битва дала греческому флоту время подготовиться к решающему сражению при Саламине, которое изменило ход всей мировой истории."
},
{
    question: "Назовите год до нашей эры, когда в Древней Греции прошли самые первые Олимпийские игры, положившие начало великой спортивной традиции?",
    hints: [
      "1. Первая цифра этого года — количество холмов, на которых был построен Вечный город (Рим). Последняя цифра — первое в математике «совершенное число» (равное сумме своих делителей).",
      "2. В мире IT этот числовой код доступа (chmod) позволяет владельцу и группе делать с файлом всё (rwx), а всем остальным — только читать и изменять его (rw-).",
      "3. Это число всего на единицу меньше индекса самого большого в мире двухдвигательного широкофюзеляжного самолета, известного как «Три семерки»."
    ],
    answer: "776",
    fact: "На самых первых играх был всего один вид состязаний — бег на одну «стадию» (около 192 метров). Победителем стал повар по имени Кореб, который навсегда вошел в историю как первый олимпийский чемпион."
},
{
    question: "Статуя Свободы — один из самых узнаваемых монументов в мире. Какова её полная высота в метрах (от основания земли до самого кончика факела)?",
    hints: [
      "1. В астрономии это значение (в миллионах миль) определяет масштаб Солнечной системы, являясь базовой единицей измерения расстояний между планетами.",
      "2. Название последнего великого романа Виктора Гюго, посвященного самому драматичному и кровавому году Великой французской революции.",
      "3. Порядковый номер года в XX веке, когда на политической карте официально появился Евросоюз, а в мире спорта — первый турнир по смешанным единоборствам UFC."
    ],
    answer: "93",
    fact: "Статуя была подарена Францией США к столетию независимости. Интересно, что медная оболочка статуи имеет толщину всего 2,4 мм — это тоньше, чем две монеты по 5 злотых, сложенные вместе. При сильном ветре факел может раскачиваться на 12 сантиметров."
},
{
    question: "На какой глубине (в метрах) лежат обломки легендарного лайнера «Титаник» на дне Атлантического океана?",
    hints: [
      "1. В международной авиации это значение в метрах считается критическим порогом (примерно 12 500 футов): выше этой отметки экипаж обязан использовать кислородное оборудование из-за разреженности воздуха.",
      "2. Это число можно получить, если к количеству секунд в одном стандартном часе прибавить общее количество метров, которое проплывают два пловца в олимпийском бассейне «туда и обратно».",
      "3. Первые две цифры этого числа — номер знаменитой параллели, разделяющей КНДР и Южную Корею. Чтобы получить всё число, умножьте эту параллель на количество квадратных метров в одной «сотке» земли."
    ],
    answer: "3800",
    fact: "Обломки лайнера были обнаружены только в 1985 году. Корпус корабля при падении на дно раскололся на две части, которые теперь лежат на расстоянии 600 метров друг от друга под колоссальным давлением в 380 атмосфер."
},
{
    question: "В каком году в Париже была открыта самая первая кофейня в мире, которая беспрерывно работает и по сей день (легендарное кафе Le Procope)?",
    hints: [
      "1. В этом же году родился немецкий физик Габриэль Фаренгейт, подаривший миру первую температурную шкалу.",
      "2. В этот год Готфрид Лейбниц официально представил миру интегральное исчисление, впервые опубликовав в печати символ интеграла — один из важнейших знаков в современной науке и программировании.",
      "3. Первая половина этого числа — атомный номер серы (S), а вторая — год в XX веке, когда произошла авария на Чернобыльской АЭС и был запущен первый модуль станции «Мир»."
    ],
    answer: "1686",
    fact: "Кафе «Прокоп» было любимым местом Вольтера (который выпивал там до 40 чашек кофе в день) и Наполеона Бонапарта. Наполеон однажды даже оставил там свою шляпу в залог, так как у него не хватило денег расплатиться за заказ."
},
{
    question: "В каком году было отправлено самое первое электронное письмо (e-mail) в истории, заложившее основу современной цифровой коммуникации?",
    hints: [
      "1. В этом же году компания Intel выпустила свой первый коммерческий микропроцессор — модель 4004, что фактически дало старт эпохе персональных компьютеров.",
      "2. Это год основания международной организации Greenpeace и мировой премьеры культового фильма Стэнли Кубрика «Заводной апельсин».",
      "3. В этом году начала работу первая в мире электронная фондовая биржа NASDAQ, а швейцарский ученый Никлаус Вирт официально представил язык программирования Pascal."
    ],
    answer: "1971",
    fact: "Первое письмо отправил программист Рэй Томлинсон самому себе в рамках сети ARPANET. Именно он выбрал символ @ (эт), чтобы разделять имя пользователя и имя компьютера, так как этот знак практически не использовался в именах и командах того времени."
},
{
    question: "Этот год стал переломным для науки. Именно тогда в Англии произошел «Великий пожар», а Исаак Ньютон, находясь на карантине, совершил свои главные открытия. Назовите этот год?",
    hints: [
      "1. В этом году во Франции была основана Академия наук, а в Париже состоялась премьера комедии Мольера «Мизантроп».",
      "2. Это уникальное число: если записать его римскими цифрами, оно будет содержать все основные символы в порядке убывания без повторений (MDCLXVI).",
      "3. Чтобы получить этот год, нужно к числу, которое в культуре считается «индексом зверя», прибавить ровно одно полное тысячелетие."
    ],
    answer: "1666",
    fact: "Во время эпидемии чумы 1666 года Ньютон уехал в деревню, где за один год открыл закон тяготения и разложил свет в спектр."
},
{
question: "Этот год стал временем триумфа человеческого духа и величайшего биологического прорыва. Именно тогда была обнаружена двойная спираль ДНК  а человек впервые вышел в космос",
    hints: [
      "1. В этом году в литературе впервые дебютировал Джеймс Бонд",
      "2. Чтобы получить этот год, нужно взять количество минут в 32 полных часах и прибавить к результату количество букв в русском алфавите (33).",
      "3. В этом году новозеландец Эдмунд Хиллари и шерпа Тенцинг Норгей стали первыми людьми, достигшими вершины Эвереста."
    ],
    answer: "1953",
    fact: "1953 год изменил всё: от понимания генетики до пределов человеческой выносливости. В этом же году в США началось регулярное цветное телевещание."
},
{


 question: "Этот год изменил медицину и массовую культуру навсегда. Именно тогда была открыта возможность спасать миллионы жизней от инфекций с помощью пенициллина, а на экранах дебютировал самый узнаваемый мышонок в мире — Mikki Maus",
    hints: [
      "1. В этом году был представлен первый прототип механического телевизора",
      "2. Если сложить все цифры этого года, получится 20, а само число делится без остатка на 4 и 8.",
      "3. Квантовая электродинамика: в этом году Поль Дирак опубликовал уравнение, описывающее электрон, что стало первым в истории науки математическим предсказанием существования антиматерии."
    ],
    answer: "1928",
    fact: "1928-й — год великих «счастливых случайностей». Александр Флеминг открыл пенициллин из-за собственной небрежности, оставив грязную чашку Петри перед отпуском, а Уолт Дисней создал Микки Мауса только потому, что потерял права на своего предыдущего героя — Кролика Освальда."
},
{
    question: "В каком году американский летчик Чарльз Линдберг совершил первый в истории одиночный беспосадочный перелет через Атлантический океан на самолете Spirit of St. Louis?",
    hints: [
      "1. Кинематограф: на экраны вышел фильм «Певец джаза» — первая в истории полнометражная картина с использованием синхронной речи, положившая конец эпохе немого кино.",
      "2. География и Политика: в Австралии официально открылось здание Парламента в Канберре, которая именно в этот момент стала полноценной столицей государства.",
      "3. Фундаментальная наука: немецкий физик Вернер Гейзенберг опубликовал свою работу, в которой сформулировал «принцип неопределенности» — одну из основ квантовой механики."
    ],
    answer: "1927",
    fact: "Линдберг летел 33,5 часа без сна. Чтобы не уснуть, он держал окно кабины открытым, чтобы холодный воздух бил в лицо, и специально сконструировал самолет без переднего окна (обзор был только через перископ), чтобы ничто не отвлекало его от приборов."
},
{
    question: "Посмотрите на этот фрагмент. Какой номер комнаты указан на бирке ключа, ставшего символом одного из самых жутких мест в истории мирового кинематографа?",
    hints: [
      "1. Рекурсивные последовательности: цифры этого номера, взятые по порядку, являются первыми тремя членами последовательности Сильвестра, которая описывает максимально эффективное разложение единицы в египетские дроби.",
      "2. Астрофизика и конспирология: в милях, умноженных на 10^3, это число составляет среднее расстояние от Земли до Луны — именно на этот факт опираются сторонники теории о том, что Кубрик этим номером «признался» в фальсификации высадки на Луну.",
      "3. Документалистика и киноанализ: в 2012 году на экраны вышел целый документальный фильм, название которого состоит исключительно из этого числа. В нем исследователи и фанаты разбирают самые безумные теории — от скрытых символов Холокоста до тайных посланий самого режиссера."
    ],
    answer: "237",
    fact: "В книге Кинга номер был 217, но администрация отеля Timberline Lodge попросила Кубрика заменить его на несуществующий в их здании 237-й номер, чтобы не пугать будущих гостей. Иронично, но после премьеры именно 217-й номер стал самым востребованным у туристов, а 237-й — синонимом паранормального ужаса."
},
{
    question: "Посмотрите на задний план этого легендарного снимка. Какое трехзначное число изображено на номерном знаке белого автомобиля Volkswagen Beetle, припаркованного слева?",
    hints: [
      "1. Конспирология: согласно теории «Пол мертв», это число, стоящее перед буквой 'F', сторонники теории читали как английское условие 'IF', намекая на возраст Маккартни, который бы ему исполнился, будь он жив.",
      "2. Теория чисел: это число является суммой первых четырнадцати простых чисел подряд (начиная с 2), что делает его редким объектом для математических исследований.",
      "3. Высшая арифметика: это «простое число Софи Жермен». Его уникальность в том, что если его удвоить и прибавить единицу, результатом снова станет простое число (563)."
    ],
    answer: "281",
    fact: "После выхода альбома номерной знак LMW 281F воровали столько раз, что владельцу машины (жителю соседнего дома) пришлось её продать. В 1986 году этот «Жук» ушел с аукциона Sotheby's за 23 000 долларов и сейчас находится в музее Volkswagen в Германии."
},
{
    question: "Посмотрите на этот фрагмент. Какое число указано на двери квартиры Томаса Андерсона (Нео), которое является прямой отсылкой к легендарному роману-антиутопии Джорджа Оруэлла?",
    hints: [
      "1. В романе Оруэлла «1984» это был номер комнаты пыток, где человек сталкивался со своим самым главным страхом.",
      "2. В университетской системе США этот номер традиционно присваивается вводным курсам для начинающих (базовый уровень).",
      "3. Это число в двоичной системе счисления выглядит как 1100101."
    ],
    answer: "101",
    fact: "В фильме этот номер символизирует то, что Нео — «Избранный» (The One), а также намекает на компьютерный код (0 и 1). Позже в фильме «Перезагрузка» он попадает на 101-й этаж, чтобы встретиться с Архитектором."
},
{
    question: "Посмотрите на этот фрагмент. Какое трехзначное число (код) было установлено на замке этого чемодана, содержимое которого так и осталось загадкой для зрителей?",
    hints: [
      "1. Математическая аномалия: это число в точности равно сумме первых 144 знаков после запятой числа p.",
      "2. Теория вероятностей и азарт: это число является суммой всех целых чисел на стандартном колесе европейской рулетки.",
      "3. Геймдев и сети: именно этот порт (TCP/UDP) официально зарезервирован организацией IANA за культовым шутером Doom (1993) для реализации многопользовательского режима."
    ],
    answer: "666",
    fact: "Существует фанатская теория, что в чемодане находилась душа Марселласа Уоллеса. Именно поэтому код замка был 666, а на затылке у Марселласа в фильме виден пластырь (якобы душу дьявол забирает именно через затылок)."
},
{
    question: "Взгляните на этот фрагмент. Какое суммарное количество «мягких» (растекающихся) и одних «твердых» часов изображено Сальвадором Дали на этом полотне?",
    hints: [
      "1. Математика и картография: согласно знаменитой теореме, это минимальное количество цветов, достаточное для раскрашивания любой карты на плоскости так, чтобы никакие две области с общей границей не имели один и тот же цвет.",
      "2. Генетика: это количество типов азотистых оснований (нуклеотидов), из которых, как из конструктора, состоит молекула ДНК любого живого существа на Земле.",
"3. В программировании это число часто означает размер одного «ниббла» (полубайта) в битах."
    ],
    answer: "4",
    fact: "Дали признавался, что идея «плавящихся часов» пришла к нему не от теории относительности, а когда он увидел, как на солнце тает мягкий сыр камамбер."
},
{
    question: "Перед вами героиня легендарного видеоролика — Наталья «Морская пехота». Какого количества рублей ей не хватило для полной оплаты проезда, что в итоге привело к эпичному конфликту и фразе «Стартуем!»?",
    hints: [
      "1. Математический анализ: это число является результатом вычисления определенного интеграла \\int_{0}^{\\infty} e^{-x} dx.",
      "2. История искусств: именно столько картин, согласно самой известной (хотя и оспариваемой) легенде, Винсент ван Гог сумел официально продать при жизни.",
      "3. Квантовая физика: это значение спина (в единицах постоянной Планка) для фотона — фундаментальной частицы, отвечающей за электромагнитное взаимодействие."
    ],
    answer: "1",
    fact: "В оригинальном видео 2010 года Наталья утверждает, что «служила в морской пехоте», и требует везти её бесплатно. Конфликт разгорелся из-за номинального отсутствия всего одного рубля, что для героини стало вопросом принципа и «чести мундира»."
},
{
    question: "Какое двузначное число фанаты теории чисел называют «Чаком Норрисом среди цифр» из-за его уникальных зеркальных и бинарных свойств?",
    hints: [
      "1. Радиоастрономия и поиск разума: это число является ключевым множителем при расшифровке «Послания Аресибо». Общий объем сообщения в 1679 бит был выбран специально, чтобы его можно было разложить в прямоугольную сетку только с такими сторонами.",
      "2. Программирование и системы счисления: в двоичном коде (Binary) это число представляет собой идеальный палиндром — 1001001.",
      "3. Радиосвязь: в азбуке Морзе это число используется как стандартное сокращение для выражения «Наилучшие пожелания» (Best Regards) в конце сеанса связи."
    ],
    answer: "73",
    fact: "Это число стало всемирно популярным благодаря Шелдону Куперу из «Теории большого взрыва». Он называл его идеальным, так как оно не только зеркально в десятичной системе (73 и 37 — оба простые), но и является 21-м простым числом, чье зеркало (12) при умножении своих цифр (1*2) дает... стоп, это опять та математика. Главное: 73 — это 1001001 в двоичной системе, палиндром, который одинаково читается в обе стороны."
},
{
    question: "Назовите четырехзначное число, известное как «Постоянная Капрекара», которое является конечной точкой любого математического пути для четырехзначных чисел (если они не состоят из одинаковых цифр).",
    hints: [
      "1. Программная петля: представьте бесконечный цикл 'while', который прерывается только тогда, когда результат функции становится равен её аргументу. Для четырех цифр этот «выход из системы» (фиксированная точка) существует в единственном экземпляре.",
      "2. Глобальный аттрактор: в теории хаоса этот результат считается универсальным финалом. Каким бы «запутанным» ни был ваш первоначальный код, он гарантированно «схлопнется» до этого значения максимум за семь итераций.",
      "3. Арифметический тупик: это число — настоящий «самоед». Если вы составите из его цифр максимально возможное число (7641) и вычтете из него минимально возможное (1467), то вы мгновенно получите тот же самый результат."
    ],
    answer: "6174",
    fact: "Индийский математик Капрекар открыл это число в 1949 году. С тех пор оно считается главной «черной дырой» арифметики: в пространстве четырехзначных чисел это единственная точка, которая не выпускает из себя результат математической операции."
},
{
    question: "Сколько различных языков мира было использовано для записи аудиоприветствий на «Золотой пластинке», которую несут на своем борту аппараты «Вояджер», улетающие в межзвездное пространство?",
    hints: [
      "1. Физика и метрология: это атомный номер Цезия (Cs) — химического элемента, чьи стабильные энергетические переходы лежат в основе работы атомных часов и определения эталона секунды.",
      "2. Международная связь: это телефонный код страны, являющейся крупнейшей в Южной Америке и единственной на континенте, где государственным языком является португальский.",
      "3. Дорожная история: в течение 20 лет (с 1974 по 1995 год) это число в милях в час служило единым федеральным пределом скорости на всех автомагистралях США."
    ],
    answer: "55",
    fact: "На пластинке записаны приветствия на 55 языках (от шумерского до современного китайского), звуки природы, музыка Баха и 115 изображений. Ученые надеются, что если инопланетная цивилизация найдет зонд, она сможет расшифровать эти данные и узнать о существовании Земли."
},
{
    question: "Сколько всего на нашей планете существует независимых горных вершин-«восьмитысячников», чья высота официально превышает критическую отметку «зоны смерти»?",
    hints: [
      "1. Физика атмосферы: это суммарное количество нуклонов (протонов и нейтронов) в ядре самого распространенного изотопа азота — газа, который составляет около 78% воздуха, которым мы дышим.",
      "2. История и власть: под этим порядковым номером правил «Король-солнце» Людовик, чье пребывание на французском престоле стало самым продолжительным за всю историю Европы.",
"3. Поэзия и литература: именно столько строк содержит классический сонет — жесткая поэтическая форма, доведенная до совершенства Шекспиром и Петраркой."
    ],
    answer: "14",
    fact: "Все 14 главных восьмитысячников планеты расположены в Центральной и Южной Азии. Первым человеком, покорившим все 14 вершин без использования кислородных баллонов, стал легендарный Райнхольд Месснер в 1986 году."
},
{
    question: "Назовите число, которое математики и специалисты по теории принятия решений считают «магическим пределом» для совершения идеального выбора в условиях неопределенности.",
    hints: [
      "1. Психология и статистика: в задачах на «оптимальную остановку» (например, при поиске идеального кандидата или жилья) это процентное значение, после которого нужно прекратить фазу «просмотра» и выбрать первого, кто окажется лучше всех предыдущих.",
      "2. Химия: это атомный номер Рубидия (Rb) — мягкого щелочного металла, который настолько активен, что самовоспламеняется на воздухе и взрывается при контакте с водой.",
      "3. Чистая арифметика: это уникальный множитель. Если умножить его на сумму трех одинаковых цифр (например, 1+1+1), результатом всегда будет трехзначное число, состоящее именно из этих цифр (111, 222 и так далее)."
    ],
    answer: "37",
    fact: "Число 37 обладает удивительной эстетикой: $37 \\times 3 = 111$, а $37 \\times 27 = 999$. В биологии оно также является опорным: средняя температура человеческого тела в 37 градусов Цельсия считается оптимальным компромиссом между скоростью химических реакций и защитой от грибковых инфекций."
}
];
