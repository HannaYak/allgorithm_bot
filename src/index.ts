...
const STOCK_QUESTIONS = [
  {
    question: "Если мы захотим выложить цепочку из планет Земля вдоль экватора Солнца, сколько таких планет нам понадобится, чтобы полностью перекрыть его диаметр? (Укажите примерное число, которое в науке считается стандартным коэффициентом отношения диаметров Солнца и Земли).",
    hints: [
      "1. Это название самого массового истребителя в истории авиации — немецкого Messerschmitt Bf... Этот самолет был «рабочей лошадкой» Люфтваффе и стал символом воздушных боев Второй мировой.",
      "2. Под этим атомным номером в таблице Менделеева скрывается Мейтнерий — единственный химический элемент, названный исключительно в честь реальной женщины-ученого.",
      "3. Это число ровно на единицу меньше, чем «десять десятков плюс десять»."
    ],
    answer: "109",
    fact: "Солнце настолько огромно, что внутри него могло бы поместиться 1,3 миллиона планет Земля. Мы — лишь песчинка на фоне нашей звезды."
  },
  {
    question: "Какое число считается «абсолютным символом процветания» на Востоке и послужило точным временем начала церемонии открытия летних Олимпийских игр в Пекине?",
    hints: [
      "1. В христианской нумерологии это число считается числом Иисуса. Если сложить числовые значения греческих букв имени Іησους, в сумме получится именно это трехзначное значение. Оно символизирует «новое творение» и победу над хаосом.",
      "2. Именно это число (в сокращенном виде) дало название масштабному народному восстанию в Мьянме (Бирме).",
      "3. В Китае за номера телефонов или автомобильные знаки, состоящие только из этой цифры, люди готовы платить сотни тысяч долларов. Всё потому, что произношение этой цифры созвучно со словом «разбогатеть»."
    ],
    answer: "888",
    fact: "В Китае число 8 символизирует бесконечную удачу. Церемония в Пекине началась ровно в 08:08:08 вечера восьмого числа восьмого месяца восьмого года, чтобы обеспечить стране максимальное процветание."
  },
  {
    question: "Великий физик Ричард Фейнман называл это число «величайшей проклятой тайной физики». Оно определяет силу взаимодействия между светом и материей. Фейнман даже советовал всем физикам написать это число на своих дверях, чтобы помнить, как мало мы знаем.",
    hints: [
      "1. Это число уникально тем, что у него нет единиц измерения. Это не метры, не секунды и не килограммы. Это чистая константа. Ученые говорят: если мы когда-нибудь встретим инопланетян, нам не нужно будет объяснять им наши системы мер — достаточно будет показать это число, и они поймут, что мы понимаем законы мироздания.",
      "2. Один из величайших физиков XX века, Вольфганг Паули, всю жизнь был одержим этим числом. Когда его экстренно госпитализировали в больницу Красного Креста в Цюрихе, он первым делом спросил номер своей палаты. Узнав, что это палата № …, он сказал: «Я отсюда уже не выйду». Так и случилось — он скончался в этой палате, подтвердив свою фатальную связь с этим числом.",
      "3. Представьте таблицу Менделеева как бесконечную лестницу. Именно на этой ступени она «ломается». Согласно расчетам, электроны у элемента с таким порядковым номером должны были бы вращаться вокруг ядра со скоростью света. Поскольку преодолеть этот барьер невозможно, ученые считают данное число теоретическим финалом химии и абсолютным пределом существования любого физического элемента во Вселенной."
    ],
    answer: "137",
    fact: "Это число (постоянная тонкой структуры) — одна из главных загадок Вселенной. Если бы оно отличалось хотя бы на 1%, звезды не смогли бы создавать углерод, и органическая жизнь была бы невозможна."
  },
  {
    question: "Для варшавского экспата Прага — это «запасной аэродром». Если вам нужно срочно сменить картонную еду на чешское вепрево колено, проще всего прыгнуть в самолет. Если пилот LOT проложит курс от аэропорта Шопена до аэропорта Вацлава Гавела по идеально прямой линии, навигатор покажет это число. Сколько километров разделяет Варшаву и Прагу «по воздуху» (по прямой)?",
    hints: [
      "1. Поклонники тяжелой музыки знают это число по первому треку на культовом альбоме «Iowa» группы Slipknot. Это телефонный код их родного города, который стал символом боли и ярости для целого поколения.",
      "2. Если перевести это число в шестнадцатеричную систему (Hex), получится 203.",
      "3. Это число — «число-зеркало» (палиндром). Оно читается одинаково с обеих сторон, а если из него вычесть 15, вы получите ровно половину от тысячи."
    ],
    answer: "515",
    fact: "Для фанатов Slipknot число 515 — это крик боли Сида Уилсона, записанный после смерти деда. А для путешественника — это всего один час полета из Польши в Чехию за нормальной едой."
  },
  {
    question: "Под этим атомным номером в таблице Менделеева скрывается Свинец (Pb). Он считается «точкой покоя» в таблице Менделеева: это последний элемент, у которого есть стабильные изотопы. Всё, что тяжелее этого числа, — радиоактивно.",
    hints: [
      "1. Это номер знаменитой американской воздушно-десантной дивизии («All-American»), которая стала легендой после высадки в Нормандии. Их нашивку с этими цифрами знает каждый любитель истории Второй мировой.",
      "2. Именно столько матчей проводит каждая команда в регулярном сезоне NBA или NHL. Это «золотой стандарт» выносливости для топовых баскетболистов и хоккеистов мира."
    ],
    answer: "82",
    fact: "Свинец — это 'кладбище' радиоактивных элементов. Большинство тяжелых металлов в конечном итоге распадаются именно до свинца, после чего процесс прекращается и материя обретает покой."
  },
  {
    question: "Согласно «М-теории» (главной претендентке на роль 'Теории Всего'), мы живем не в четырехмерном мире, а в пространстве, где существует именно столько измерений. Остальные просто свернуты так мелко, что мы их не видим.",
    hints: [
      "1. Если вы решите опуститься в самую глубокую точку планеты — Марианскую впадину, вам придется преодолеть путь длиной именно в такое количество километров.",
      "2. Именно столько километров в секунду составляет Вторая космическая скорость. Это минимальный порог, который нужно преодолеть любому объекту, чтобы навсегда вырваться из гравитационного плена Земли.",
      "3. Это номер легендарной миссии «Аполлон», которая впервые в истории высадила людей на Луну."
    ],
    answer: "11",
    fact: "Физики верят, что 11 измерений — это необходимый минимум, чтобы объединить все силы природы в одну формулу. Мы видим лишь три из них, плюс время, а остальные скрыты в микромире."
  },
  {
    question: "Лондонский метрополитен (The Tube) — старейший в мире. За 160 лет он разросся в гигантский лабиринт, и после последнего расширения ветки Northern в 2021 году количество остановок достигло нынешнего максимума. Сколько всего действующих станций в лондонском метро сегодня?",
    hints: [
      "1. Именно столько слов (ни больше, ни меньше) содержится в легендарной Геттисбергской речи Авраама Линкольна — одной из самых коротких и влиятельных речей в истории человечества.",
      "2. Это число всего на 8 единиц меньше, чем текущий (расширенный) лимит символов в одном посте в X (Twitter).",
      "3. Если сложить все цифры этого числа, получится такое же количество как игроков на футбольном поле."
    ],
    answer: "272",
    fact: "Несмотря на название 'Подземка', более половины системы (55%) находится на поверхности. Во время Второй мировой войны некоторые станции-призраки использовали как секретные архивы и бункеры для сокровищ Британского музея."
  },
  {
    question: "Этот космический парадокс ломает интуицию: если выстроить в ряд все планеты Солнечной системы (включая гиганты Юпитер и Сатурн), они почти идеально поместятся в промежутке между Землей и Луной. Сколько «планет Земля» (в единицах диаметра) эквивалентно этому расстоянию?",
    hints: [
      "1. Это общее количество команд, играющих в основной лиге NBA (баскетбол) на сегодняшний день.",
      "2. Именно столько серебряных монет, согласно библейскому сюжету, получил Иуда Искариот за свое предательство.",
      "3. В классических настольных нардах это суммарное количество всех фишек (белых и черных), участвующих в игре."
    ],
    answer: "30",
    fact: "Среднее расстояние до Луны — 384 400 км. Суммарный диаметр всех остальных планет — около 380 000 км. Это значит, что всё величие космоса может уместиться у нас под боком, и еще останется место для Плутона."
  },
  {
    question: "В этом году нашей эры халиф аль-Мансур заложил первый камень в основание города, который задумывался как «Обитель мира» (Мадинат ас-Салам). Сегодня этот город известен всему миру как Багдад. На протяжении веков он был центром науки, философии и культуры всего исламского мира. Назовите этот год?",
    hints: [
      "1. (Оружие): Это самое узнаваемое число в мире боеприпасов. Именно такой диаметр (в миллиметрах) имеют пули самых известных автоматов и винтовок в истории — от легендарного АК-47 до винтовок НАТО и СВД.",
      "2. Это примерное значение скорости звука в милях в час при стандартных атмосферных условиях на уровне моря. Предел, за которым начинается звуковой барьер.",
      "3. Если вы разделите это число на 6, то получите 127 — еще одно простое число."
    ],
    answer: "762",
    fact: "Багдад строился как идеальный круг, в центре которого стоял дворец халифа. Это был символ того, что город является центром Вселенной и мировой мудрости."
  },
  {
    question: "Если вытянуть в одну линию все кровеносные сосуды (капилляры, вены, артерии) одного взрослого человека, их общая длина составит именно столько километров.",
    hints: [
      "1. В Великобритании именно столько подписей должна собрать петиция на официальном сайте правительства, чтобы вопрос был в обязательном порядке рассмотрен для обсуждения в Палате общин (парламенте).",
      "2. Этой нитью можно обернуть Землю по экватору 2.5 раза.",
      "3. В Индии, Пакистане и Шри-Ланке для этого конкретного числа существует специальное слово, которое официально используется в бизнесе и новостях чаще, чем «миллион». Оно называется «Лакх» (Lakh)."
    ],
    answer: "100000",
    fact: "Длина сосудов одного человека в 10 раз больше, чем расстояние от Лондона до Токио. Космическая логистическая сеть внутри каждого из нас!"
  },
  {
    question: "Это число в математике называют «Числом Бога». Оно определяет абсолютный предел сложности самой популярной механической головоломки в мире. Из любого, самого запутанного состояния, объект можно вернуть в исходный вид ровно за столько ходов. Назовите это число?",
    hints: [
      "1. Столько молочных зубов вырастает у ребенка к трехлетнему возрасту в полной физиологической норме.",
      "2. Это количество граней у правильного икосаэдра. В настольных ролевых играх (как D&D) такую кость называют «D20» и считают главным символом судьбы.",
      "3. В стандартной колоде карт Таро этот номер носит старший аркан «Суд» (Judgement)."
    ],
    answer: "20",
    fact: "Для кубика Рубика 3х3 не существует комбинации, которую нельзя было бы решить за 20 или менее ходов. Математики потратили 30 лет на вычисления, чтобы доказать: этот «потолок» невозможно преодолеть."
  },
  {
    question: "В этом году до нашей эры произошло событие, изменившее карту мира: великий персидский царь Кир II вошел в Вавилон, положив конец Нововавилонскому царству. Это событие не просто сменило власть, но и привело к созданию «Цилиндра Кира», который многие историки называют первой в мире декларацией прав человека. Назовите этот год?",
    hints: [
      "1. Это основной телефонный код штата Оклахома для региона Талса. Если вы ведете бизнес с технологическими компаниями Среднего Запада, этот код будет мелькать в ваших контактах постоянно.",
      "2. Это число является результатом умножения «числа удачи» в квадрате на «первое двузначное палиндромное число».",
      "3. Это число идет сразу после самого известного кода ошибки в интернете (540 — это уже из области перегрузки серверов), если считать в обратном порядке от 540."
    ],
    answer: "539",
    fact: "Захват Вавилона Киром Великим вошел в историю как 'бескровный'. Он не разрушил город, а приказал освободить рабов и уважать местные храмы, что было неслыханно для той эпохи."
  },
  {
    question: "Столько раз жизнь на Земле была практически полностью уничтожена в ходе глобальных катастроф (массовых вымираний).",
    hints: [
      "1. Столько сторон и углов у пентагона.",
      "2. На таком количестве линеек пишется любая современная нотная партитура (нотный стан).",
      "3. Это номер в названии самого знаменитого аромата от Chanel."
    ],
    answer: "5",
    fact: "Самое крупное вымирание (Пермское) уничтожило 96% видов в океане. Каждый раз жизнь возвращалась и становилась сложнее. Сейчас мы официально живем в эпоху шестого вымирания."
  },
  {
    question: "Это число стало символом триумфа науки над безнадежностью. Именно такой лабораторный порядковый номер носил первый в истории эффективный химиотерапевтический препарат (Сальварсан), созданный Паулем Эрлихом. Число означает, что лекарство было найдено ровно после такого количества попыток и неудачных экспериментов. Назовите это число?",
    hints: [
      "1. Это индекс культовой программируемой драм-машины от компании Roland (TR-...), выпущенной в 1981 году. Её специфический «металлический» звук тарелок стал фундаментом для раннего техно и эйсид-хауса.",
      "2. Это телефонный код восточной части штата Кентукки (США). Если вы увидите этот код на экране, значит, вам звонят из сердца Аппалачей.",
      "3. Это число — палиндром (читается одинаково в обе стороны), сумма цифр которого в точности равна количеству апостолов на «Тайной вечере»."
    ],
    answer: "606",
    fact: "Пауль Эрлих доказал, что наука — это терпение. Он ошибся 605 раз, чтобы на 606-й попытке найти формулу, которая спасла миллионы жизней от сифилиса."
  },
  {
    question: "Это число — «нижняя граница» всего сущего. Точка, в которой замирает даже время (на атомарном уровне). При этой температуре атомы перестают двигаться. Достичь её абсолютно точно невозможно — это физический тупик Вселенной.",
    hints: [
      "1. В этом году нашей эры римский император Аврелиан, получивший титул «Реставратор мира», наконец воссоединил Римскую империю, окончательно разгромив Пальмирское царство и вернув под контроль Галлию.",
      "2. Это результат умножения трех самых мистических и популярных в фольклоре чисел: «Божественной троицы», «Числа удачи» и «Чертовой дюжины».",
      "3. Если взять продолжительность одного сидерического месяца (время, за которое Луна делает полный оборот вокруг Земли относительно звезд), и умножить это значение на 10, мы получим наш ответ."
    ],
    answer: "273",
    fact: "Абсолютный ноль (-273,15°C) — это единственное место во Вселенной, где кофе никогда не остынет, потому что теплопередача там просто перестает работать."
  },
  {
    question: "Это число — главный пароль и символ ранней интернет-культуры. Его используют хакеры и геймеры по всему миру, чтобы обозначить свою элитарность.",
    hints: [
      "1. Именно в этом году официально началась Столетняя война между Англией и Францией — самый долгий и кровопролитный конфликт в истории средневековой Европы, подаривший миру Жанну д’Арк.",
      "2. Под этим номером в астрономическом каталоге NGC значится спиральная галактика в созвездии Эридана. Она находится от нас на расстоянии около 50 миллионов световых лет.",
      "3. Если вы отправите письмо в небольшой городок Эрвинг в штате Массачусетс (США), его почтовый индекс (ZIP-code) будет начинаться с нуля, за которым последуют именно эти четыре цифры."
    ],
    answer: "1337",
    fact: "Число визуально напоминает слово LEET (elite). Удивительно, что хакерский символ 'элитности' в точности совпадает с температурой плавления золота по Кельвину."
  },
  {
    question: "Это число — фундамент нашей способности двигаться и чувствовать. Именно столько пар нервов отходит от спинного мозга человека, чтобы управлять всем телом: от кончиков пальцев до легких.",
    hints: [
      "1. Это число — «максималист». Ровно у семи месяцев в году есть этот день.",
      "2. Для Польши это число священно: именно в этот день августа 1980 года в Гданьске было подписано соглашение, давшее свободу профсоюзу «Солидарность».",
      "3. Если вы зайдёте в мировую сеть кафе Baskin-Robbins, вы увидите это число на логотипе. Оно означает «по одному вкусу на каждый день месяца»."
    ],
    answer: "31",
    fact: "31 пара спинномозговых нервов — это главная информационная шина нашего организма. Каждая пара отвечает за свой сегмент тела, как кнопки на пульте управления."
  },
  {
    question: "Это число — длительность самого короткого военного конфликта в мировой истории (в минутах). За это время одна сторона успела полностью уничтожить береговую оборону противника, а вторая — спустить флаг и сдаться. Назовите продолжительность Англо-занзибарской войны?",
    hints: [
      "1. Это числовое значение географической параллели, которая официально разделяет Северную и Южную Корею.",
      "2. Именно столько игровых секторов (номеров) находится на колесе американской рулетки в казино, если считать «зеро» и «дабл-зеро».",
      "3. В мире роскошных наручных часов это число в миллиметрах считается «золотым стандартом» и классическим унисекс-диаметром корпуса."
    ],
    answer: "38",
    fact: "27 августа 1896 года Британия и Занзибар воевали ровно 38 минут. Занзибарцы потеряли 500 человек, британцы — одного раненого матроса. Это была самая быстрая и односторонняя война в истории."
  },
  {
    question: "Это число — настоящий «выживший». Именно столько людей спаслось в ночь на 15 апреля 1912 года после столкновения самого известного лайнера в истории с айсбергом. Общее количество людей на борту «Титаника» было около 2200. Погибло более 1500. Сколько человек поднялось на борт спасательного судна «Карпатия»?",
    hints: [
      "1. В современной Польше это число стало главным футбольным мемом страны: именно столько телефонных звонков, согласно расследованию, сделал бывший тренер сборной Польши Чеслав Михневич главарю футбольной мафии по кличке «Парикмахер».",
      "2. В самой популярной игре в кости (Craps) это сочетание называют «Натуральным» (The Natural). Если игрок на первом же броске выкидывает сумму .. или .., он побеждает мгновенно. Это символ абсолютной удачи для тех, кто ставит на кон всё.",
      "3. Это название крупнейшей в мире сети магазинов шаговой доступности (convenience stores), которой, по иронии судьбы, всё еще нет в Польше, хотя она есть почти в каждой стране мира."
    ],
    answer: "711",
    fact: "Из 2200 человек спаслись только 711. Большинство из них были пассажирами первого класса, в то время как третий класс практически весь ушел на дно."
  },
  {
    question: "Это число — легендарная математическая ловушка. Существует древняя притча о награде изобретателю игры: на первую клетку поля нужно положить 1 зернышко, на вторую — 2, на третью — 4 и так далее. Назовите финальное количество клеток, на котором зерна на планете физически закончилось?",
    hints: [
      "1. В древнекитайской «Книге Перемен» (И-цзин) именно такое количество гексаграмм описывает все возможные состояния мира и судьбы.",
      "2. Это международный телефонный код Новой Зеландии. Если вам звонят с этого префикса — это привет от хоббитов.",
      "3. Столько кодовых комбинаций (триграмм) содержит генетический код человека для кодирования аминокислот."
    ],
    answer: "64",
    fact: "Чтобы расплатиться с изобретателем шахмат, понадобилось бы 18 квинтиллионов зерен. Это гора размером с Эверест. Ни один правитель в мире не смог бы выполнить это условие."
  },
  {
    question: "Это число — мировой стандарт самой престижной игры для аристократов. Существует культовая легенда, что такая дистанция была выбрана не инженерами, а любителями виски: именно столько порций («дрэмов») содержится в стандартной бутылке скотча.",
    hints: [
      "1. Именно столько глав содержится в «Бхагавад-гите» — одном из самых почитаемых священных текстов в мире.",
      "2. В стандартной колоде Таро под этим номером идет карта «Луна», символизирующая интуицию, подсознание и скрытые страхи.",
      "3. В американской культуре дальнобойщиков традиционно считается, что именно столько колес имеет классическая фура (18-wheeler)."
    ],
    answer: "18",
    fact: "Хотя легенда про бутылку виски и 18 лунок в гольфе — это скорее миф, число стало каноном в 1764 году. Шотландцы из Сент-Эндрюса решили, что 18 этапов — это идеальная мера для игры."
  },
  {
    question: "Это число — биологический код созидания. В мире медицины и антропологии оно обозначает среднюю продолжительность (в днях) пути от одной единственной клетки до рождения нового человека, если вести отсчет именно от момента зачатия. Назовите это число?",
    hints: [
      "1. Это официальный порядковый номер нынешнего Папы Римского Франциска в общем историческом списке всех глав Католической церкви.",
      "2. В 1997 году это число было самой желанной характеристикой (в МГц) для топового процессора Intel Pentium II. Этот чип совершил революцию, перейдя на картриджную архитектуру Slot 1.",
      "3. Если вы решите провести в пути ровно 4 часа и 26 минут, то суммарно ваша дорога займет именно такое количество минут."
    ],
    answer: "266",
    fact: "266 дней от зачатия — это настоящее время рождения. Хотя врачи обычно считают 280 дней от начала цикла, жизнь начинается именно в этот 266-й день."
  },
  {
    question: "Это число стало символом одного из самых благородных поступков XX века. Именно столько детей (в основном еврейского происхождения) спас от нацистов британский гуманитарий Николас Уинтон, организовав их вывоз из оккупированной Праги в Лондон. Об этом подвиге мир узнал только спустя 50 лет, когда его жена случайно нашла на чердаке записную книжку со списком имен. Назовите количество спасенных «детей Уинтона»?",
    hints: [
      "1. В международном каталоге под этим номером (NGC...) значится гигантская спиральная галактика в созвездии Андромеды, расположенная от нас на расстоянии около 200 миллионов световых лет.",
      "2. В мире телекоммуникаций это число является «тенью» (overlay-кодом) легендарного кода 408. Его ввели в самом сердце Кремниевой долины, когда старых номеров перестало хватать для всех инженеров Apple и Google.",
      "3. Если разложить это число на отдельные цифры и сложить их , вы получите самое желанное число для любого игрока в казино, означающее мгновенную победу."
    ],
    answer: "669",
    fact: "Николас Уинтон не считал себя героем и молчал о своем подвиге полвека. Сегодня тысячи потомков этих детей называют себя 'семьей Уинтона'."
  },
  {
    question: "Под этим легендарным номером выпускается самая известная модель джинсов в истории компании Levi Strauss & Co. Изначально созданные как сверхпрочная рабочая одежда для золотоискателей с медными заклепками на карманах, они стали культурным кодом для десятков поколений. Назовите номер этой культовой модели?",
    hints: [
      "1. Это стандартный начальный счет в профессиональном Дартсе. Игроки должны списать именно это количество очков до нуля, закончив игру обязательным попаданием в «удвоение» или «яблочко».",
      "2. В американском законодательстве это число — «билет в мир добрых дел». Статус этот означает, что организация является некоммерческой и освобождается от налогов. Для любого крупного фонда в США это самое важное число в документах.",
      "3. Это число носит самый известный легион штурмовиков во вселенной «Звездных войн» — также известный как «Кулак Вейдера». Интересно, что в реальном мире так называется крупнейшая организация косплееров, которые создают профессиональные костюмы имперцев."
    ],
    answer: "501",
    fact: "Медные заклепки на 501-й модели изначально были на всех карманах, включая задние, но их пришлось убрать, так как они царапали седла лошадей и кожаные кресла."
  },
  {
    question: "Если собрать вместе всех людей, когда-либо живших на планете Земля с момента появления Homo Sapiens, их общее количество составит именно столько миллиардов.",
    hints: [
      "1. Именно на этом этаже (107-й этаж) в Северной башне Всемирного торгового центра в Нью-Йорке располагался легендарный ресторан «Windows on the World». До 2001 года это была самая высокая точка в мире, где можно было поужинать, глядя на облака сверху вниз.",
      "2. В Аргентине именно этот короткий номер является официальным номером государственной скорой медицинской помощи.",
      "3. Это значение (в градусах) является идеальным углом связи в молекуле аммиака. Именно под таким углом атомы водорода «расходятся» от атома азота, создавая форму пирамиды, которая лежит в основе множества удобрений и чистящих средств по всему миру."
    ],
    answer: "107",
    fact: "На каждого живого человека сегодня приходится примерно 14 тех, кто уже умер. Мы — всего лишь верхушка огромного айсберга человеческой истории."
  },
  {
    question: "Под этим атомным номером в таблице Менделеева скрывается серебристо-белый металл, названный в честь скандинавского бога грома. Ученые пророчат ему роль «топлива будущего», так как он способен заменить уран в ядерных реакторах, будучи при этом гораздо более безопасным и эффективным. Назовите атомный номер Тория?",
    hints: [
      "1. Это предельное цифровое значение широты. Если вы достигли этой точки, то куда бы вы ни повернули — вы всегда будете идти на юг (или на север).",
      "2. Если вычесть из этого числа время перерыва, мы получим общую продолжительность нахождения футболистов на поле в рамках основного времени матча.",
      "3. Это количественная мера угла, который строители называют «входящим». Без соблюдения этого параметра не стоит ни один небоскреб в мире."
    ],
    answer: "90",
    fact: "Торий в три раза более распространен в земной коре, чем уран. Один килограмм тория может произвести столько же энергии, сколько 3000 тонн угля."
  },
  {
    question: "При какой температуре (в градусах Цельсия, округленно до целого числа) начинает закипать и превращаться в газ единственный металл на планете, который остается жидким при комнатной температуре? Назовите точку кипения ртути?",
    hints: [
      "1. Это число — имя «первенца». Именно такой индекс носил самый первый серийный автомобиль, выпущенный под маркой Porsche в 1948 году. Без этой машины не существовало бы легендарной 911-й.",
      "2. Это расстояние в тысячах километров от Земли до Луны в момент её максимального сближения с нами (в перигее). Это тот самый момент, когда мы видим в небе «Суперлуние».",
      "3. Это число — идеальный визуальный обман. Мозг часто принимает его за количество дней в году, потому что цифры идентичны, но стоят в другом порядке."
    ],
    answer: "356",
    fact: "Ртуть настолько тяжелая, что в литровой банке этого жидкого металла будет больше 13 килограммов веса. Если вы уроните в неё железную гирю, она будет плавать на поверхности."
  },
  {
    question: "В Северной Америке некоторые телефонные коды становятся мощными культурными брендами. Это трехзначное число — «цифровое лицо» Монреаля. Оно настолько вшито в ДНК города, что стало названием популярного бренда одежды, упоминается в сотнях рэп-хитов и служит паролем «для своих». Назовите этот главный телефонный код Монреаля?",
    hints: [
      "1. Это длина волны (в нанометрах) самого мощного и яркого зеленого луча в аргоновом лазере. Именно этот поток света используют хирурги для тончайших операций на сетчатке глаза.",
      "2. В этом году нашей эры на папский престол взошел Гормизд — человек, который вошел в историю как великий дипломат, сумевший остановить первый масштабный раскол между церквями Рима и Константинополя.",
      "3. Это дата рождения создателя Facebook Марка Цукерберга, если записать её цифрами в формате «Месяц-День»."
    ],
    answer: "514",
    fact: "Код 514 стал настолько дефицитным, что для новых жителей Монреаля ввели другие коды, но 'настоящими' монреальцами считаются только обладатели номеров на 514."
  },
  {
    question: "В этом году легендарный вождь викингов Рагнар Лодброк на 120 кораблях поднялся по реке Сене и впервые в истории захватил Париж. Чтобы захватчики покинули город, франкскому королю Карлу Лысому пришлось заплатить гигантский выкуп в 7000 фунтов серебра. В каком году это произошло?",
    hints: [
      "1. Это название легендарного чипсета от Intel (серия i...), который стоял в большинстве компьютеров с процессором Pentium 4 в начале 2000-х. Настоящий символ «золотого века» офисных и домашних ПК.",
      "2. Это основной телефонный код штата Нью-Йорк для региона Гудзон-Вэлли. Почти все номера в пригородах «Большого яблока» начинаются именно на эти три цифры.",
      "3. Если представить это число как время на часах, то до «круглых» девяти часов останется ровно четверть часа."
    ],
    answer: "845",
    fact: "После получения выкупа викинги пообещали уйти, но на обратном пути все равно разграбили несколько французских городов. Викинги — люди слова, но слово это было переменчивым."
  },
  {
    question: "В этом году нашей эры произошло событие, известно как Хиджра — переселение пророка Мухаммеда и его сторонников из Мекки в Медину. Именно этот год стал точкой отсчета для исламского лунного календаря и началом новой эры в истории Востока. Назовите этот год?",
    hints: [
      "1. Это число (в Мбит/с) является стандартом скорости передачи данных для интерфейсов OC-12 (или STM-4) в оптоволоконных сетях. На этой скорости работают магистральные каналы, связывающие целые города.",
      "2. В нанометрах (нм) это значение соответствует длине волны ярко-оранжевого света. Этот поток находится на самой границе видимого спектра между желтым и красным цветами.",
      "3. Этот числовой индекс носит самая успешная грузовая модификация широкофюзеляжного самолета Airbus A300 (model -622R). Эти машины до сих пор составляют основу флота крупнейших мировых почтовых служб, таких как FedEx и UPS."
    ],
    answer: "622",
    fact: "С этого момента началось не просто летоисчисление, а рождение новой мировой цивилизации, которая сохранила для нас знания античности в период Темных веков Европы."
  },
  {
    question: "Это число — «священный грааль» для любителей классических суперкаров. Именно столько лошадиных сил выдает 4.5-литровый двигатель легендарной Ferrari 458 Italia. Это была последняя модель из Маранелло с атмосферным V8, чей звук фанаты сравнивают с оперным пением.",
    hints: [
      "1. В мире частной авиации это число (в узлах) является предельной крейсерской скоростью для некоторых моделей бизнес-джетов высшего класса, таких как Gulfstream. Это граница, за которой начинается сверхзвук или разрушение конструкции.",
      "2. Именно в … н.э. родился пророк Мухаммед. Этот год стал точкой отсчета для огромных геополитических сдвигов в истории Востока и Запала.",
      "3. Если вы играли в Need for Speed или Forza, то точно знаете модель McLaren с этим номером. Это была самая массовая машина бренда, и это число написано у неё прямо на борту."
    ],
    answer: "570",
    fact: "Двигатель Ferrari 458 — это произведение искусства. Он развивает 9000 оборотов в минуту, создавая тот самый пронзительный звук, который невозможно спутать ни с одной другой машиной."
  }
];
