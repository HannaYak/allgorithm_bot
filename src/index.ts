...
const STOCK_QUESTIONS = [
  ...
  },
  {
    ...
    hints: [
      ...
      "2. Это количество граней у правильного икосаэдра. В настольных ролевых играх (как D&D) такую кость считают главным символом судьбы.",
  ...
  },
  {
    ...
    hints: [
      ...
      "3. Это число идет сразу после самого известного кода ошибки в интернете, если считать в обратном порядке от 540."
    ],
    answer: "539",
  ...
  },
  {
    ...
    hints: [
      ...
      "3. В американской культуре дальнобойщиков традиционно считается, что именно столько колес имеет классическая фура."
    ],
    answer: "18",
  ...
  },
  {
    ...
    hints: [
      "1. Именно на этом этаже в Северной башне Всемирного торгового центра в Нью-Йорке располагался легендарный ресторан «Windows on the World». До 2001 года это была самая высокая точка в мире, где можно было поужинать, глядя на облака сверху вниз.",
  ...
  },
  {
    ...
    hints: [
      ...
      "3. Этот числовой индекс носит самая успешная грузовая модификация широкофюзеляжного самолета Airbus A300. Эти машины до сих пор составляют основу флота крупнейших мировых почтовых служб, таких как FedEx и UPS."
    ],
    answer: "622",
...
const registerWizard = new Scenes.WizardScene(
  ...
  async (ctx) => {
    ...
    await ctx.reply('2. Сколько тебе полных лет? Введи только число (например: 28). Это нужно для подбора компании твоего возраста. ✨');
    return ctx.wizard.next();
  },
  ...
  async (ctx) => {
    ...
    await ctx.reply(
      '3. Твой пол? Это критически важно для баланса пар на быстрых свиданиях. ⚖️:',
...
bot.action('game_stock', async (ctx) => {
  ...
  const text = `🧠 <b>Stock and Know</b>\n\n` +
    ...
    `⏳ <b>Время:</b> 2 часа | 👥 <b>Игроков:</b> до 8\n🍲 <b>Меню:</b> ⚠️ Обрати внимание: в стоимость билета входит участие и организация. Твои заказы по меню ресторана оплачиваются отдельно в конце вечера.`;
