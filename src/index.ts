...
bot.action('game_talk', async (ctx) => {
  ...
  const text = `🥂 <b>Talk and Toast</b>\n\n` +
    ...
    `Бот автоматически вышлет первую тему для обсуждения. Как только вы будете готовы двигаться дальше, получить следующую глубокую тему можно нажав на клавишу <b>«Новая тема»</b> 🎲\n\n` +
    `<b>Зачем это?</b>\n` +
    ...
    `• Новые знакомства с людьми, которых вы бы никогда не встретили 🌍\n` +
