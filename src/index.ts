...
const STOCK_QUESTIONS = [
  ...
  {
    question: "Это число является третьим по счету в ряду «совершенных чисел» (первые два — 6 и 28). В математике так называют крайне редкие числа, которые в точности равны сумме всех своих делителей, кроме самого себя. Назовите это совершенное число?",
    hints: [
      "1. Это число — фундамент современной науки о мироздании. В теории суперструн именно такая размерность необходима для того, чтобы в расчетах исчезли математические аномалии и физический мир обрел стабильность.",
      "2. Если вы начнете складывать все целые числа подряд, начиная с единицы (1 + 2 + 3 + …) и остановитесь на числе 31, то итоговая сумма будет равна именно этому значению.",
      "3. Это число ровно на 4 единицы меньше, чем «круглый» рубеж в полтысячи."
    ],
    answer: "496",
    fact: "Совершенные числа настолько редки, что за всю историю человечества их было найдено чуть больше 50 штук. Число 496 считалось божественным еще в античности."
  },
  {
  ...
  },
  {
    ...
    answer: "329",
    fact: "BMW 329 — коллекционный артефакт 1937 года. Это была попытка создать массовый спортивный кабриолет на базе уже существующих узлов до того, как бренд стал мировым гигантом."
  },
  {
  ...
  {
    question: "Это число в метрах является официальной высотой знаменитого Кёльнского собора. Когда его достроили в 1880 году, он на четыре года стал самым высоким зданием в мире. Его гигантские башни-близнецы до сих пор определяют облик города и считаются эталоном немецкой готики. Назовите высоту Кёльнского собора?",
    hints: [
      "1. Под этим индексом (ЗИЛ-...) выпускался легендарный советский грузовик-вездеход, получивший в народе прозвища «Захар» или «Колун». Эта машина с тремя ведущими мостами была королем бездорожья и основной силой в армии и сельском хозяйстве на протяжении десятилетий.",
      "2. Это 37-е простое число в бесконечном ряду чисел, которые делятся только на себя и на единицу. В нумерологии его иногда называют «числом духовного поиска».",
      "3. В милях в час это число соответствует 252 км/ч. Это порог, который во многих странах считается «джентльменским ограничением» скорости для мощных немецких седанов (хотя официально ограничитель ставят на 250, спидометр часто показывает именно это значение)."
    ],
    answer: "157",
    fact: "Во время Второй мировой войны союзники не бомбили Кёльнский собор, потому что его 157-метровые шпили были идеальным ориентиром на местности для пилотов."
  },
  {
  ...
  {
    question: "Какова высота в метрах самого высокого колеса обозрения в мире в период с 2014 по 2021 год — знаменитого High Roller в Лас-Вегасе? (Укажите целое число).",
    hints: [
      "1. Это индекс американского бомбардировщика «Мартин», который активно использовался британскими и французскими ВВС в начале Второй мировой войны.",
      "2. Примерно столько калорий содержится в двух больших чашках кофе с молоком без сахара. Практически «топливо» для одного рабочего утра.",
      "3. Если год не является високосным, то именно это число обозначает порядковый номер дня в календаре, на который выпадает 16 июня. Это «математический адрес» этой даты во времени."
    ],
    answer: "167",
    fact: "Колесо High Roller делает полный оборот за 30 минут — это время идеально рассчитано для того, чтобы пассажиры успели допить свой коктейль в кабинке-баре."
  },
  {
